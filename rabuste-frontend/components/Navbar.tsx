  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(184, 115, 51, 0.05), transparent)",
      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto relative z-10">
        ...
        <div
          className="flex md:hidden items-center gap-3 flex-1 relative"
          style={{ zIndex: 1002 }}
        >
          <button
      ...
      >
        ...
        >
          {/* Close Button Header */}
          <div
            className="sticky top-0 z-10 flex items-center justify-between p-4 border-b border-[#B87333]/20"
            style={{
    ...
    return (
      <button
        ...
        className={`${base} ${hoverStyles} ${
          mobile ? "w-full text-center border-[#B87333]/20" : ""
        }`}
      >
    ...
    <Link href={href} onClick={onClick} className="block">
      ...
      >
        <div
          ...
          style={{
            background: isActive ? "#B87333" : "rgba(184, 115, 51, 0.1)",
            border: `1px solid ${
              isActive ? "#B87333" : "rgba(184, 115, 51, 0.2)"
            }`,
          }}
        >
          <Icon
